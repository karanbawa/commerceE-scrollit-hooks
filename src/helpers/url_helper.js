...
// export const POST_FAKE_JWT_LOGIN = "/v1/login/basic"
export const POST_FAKE_PASSWORD_FORGET = "/fake-forget-pwd";
export const POST_FAKE_JWT_PASSWORD_FORGET = "/jwt-forget-pwd";
export const SOCIAL_LOGIN = "/social-login";
export const POST_FAKE_LOGIN_TEST = "http://localhost:8080/v1/login/basic";
...
export const GET_PRODUCTS_TEST = "http://localhost:8080/v1/allproducts";
